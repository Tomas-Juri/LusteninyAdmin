                        ...
                        <>
                          ...
                          {cypher === "solvedWithHelp" && (
                            <span className="relative">
                              ...
                              <span className="absolute -right-1 -top-[2.5px] rounded-full bg-white shadow-sm">
                                <LightBulbIcon className="size-4 rounded-full bg-amber-500 p-[2px] text-white"></LightBulbIcon>
                              </span>
                            </span>
                          )}
                          {cypher === "skipped" && (
